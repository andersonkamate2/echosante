...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    loginDescription: 'Connectez-vous avec vos identifiants administrateur pour gérer les contenus JSON.',
    email: 'Email',
    ...
    dashboardDescription: 'Gérez les contenus publiés et les brouillons depuis les fichiers JSON locaux.',
  ...
  en: {
    ...
    admin: 'Admin',
    loginTitle: 'Login',
    loginDescription: 'Sign in with your admin credentials to manage local JSON content.',
    email: 'Email',
    password: 'Password',
    emailPlaceholder: 'admin@echosante.org',
    passwordPlaceholder: '••••••••',
    ...
    dashboardDescription: 'Manage published content and drafts from local JSON files.',
    loading: 'Loading…',
